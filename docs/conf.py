...
"""
legacy-appsembler-api documentation build configuration file.
...
project = 'legacy-appsembler-api'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Legacy appsembler_api'
...
#
# html_title = 'legacy-appsembler-api v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Provides otherwise deprecated appsembler_api as a plugin LMS app',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'appsembler_api'),
                os.path.join(root_path, 'appsembler_api/migrations')])
